...
@Slf4j
public class RabbitMqShortLinkStatsConsumer {
    ...
    public void onMessage(Map<String,String> producerMap) {
        System.out.println("短链接监控的消息为："+producerMap);
        String keys = producerMap.get("keys");
        String record = producerMap.get("statsRecord");
        ShortLinkStatsRecordDTO statsRecordDTO = JSON.parseObject(record, ShortLinkStatsRecordDTO.class);
...
//                String gid = statsRecordDTO.getGid();
                ShortLinkStatsRecordDTO statsRecord = JSON.parseObject(producerMap.get("statsRecord"), ShortLinkStatsRecordDTO.class);
                actualSaveShortLinkStats(fullShortUrl, null, statsRecord);
            }
        } catch (Throwable ex) {
